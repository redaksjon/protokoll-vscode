...
export class TranscriptToolHandler implements ToolHandler {
  ...
  private initializeDefaultFixtures(): void {
    ...
    this.responses.set('protokoll_summarize_transcript', {
      summaryId: 'summary-mock',
      summary: '# Mock Summary\n\nGenerated by test mock.',
      generatedAt: '2026-01-31T00:00:00.000Z',
    });
    this.responses.set('protokoll_delete_transcript_summary', { success: true });
    ...
    this.responses.set('protokoll_get_enhancement_log', { entries: [], total: 0 });
    this.responses.set('protokoll_reject_correction', { success: true, message: 'Correction rejected' });
  }
